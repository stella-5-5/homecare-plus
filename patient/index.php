      ...
      <div class="container-fluid">
        <div class="row mb-2 w-100 ml-auto">
          <div class="col-sm-12">
            ...
            <hr>
            <h5 class="text-muted text-center">Below are available nurses</h5>
          </div><!-- /.col -->
        ...
        <?php foreach($specs as $i=>$spes):{?>
          ...
          <div class="col-lg-6">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                <p class="card-text">Hi I am Nurse <strong><?php echo htmlspecialchars($spes["specialist_name"])?></strong>I am free click here to book an appointment with me am Currently located in <strong><?php echo $spes["specialist_location"]?></strong>
