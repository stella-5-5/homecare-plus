            ...
            <div class="card card-primary card-outline">
              <div class="card-header d-flex justify-content-between">
                <div class="left d-inline">
                    <h5 class="card-title m-0"><?php echo $i+1?></h5><h6 class="card-title">&nbsp;<span class="text-muted">Nurse</span> <span class="text-danger"><?php echo $pat["specialist_name"]?></span></h6>
                </div>
