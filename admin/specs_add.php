  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Enter correct details for new specialist</h1>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card custom-card w-75 m-auto">
						<div class="card-body">
							<h4 class="text-center text-muted mb-3">Add new Nurse</h4>
							<hr>
							...
							<form method="POST" action="../control/signup.inc.php">
								...
								<hr><h4 class="text-center text-muted">Enter  nurse  Login Info</h4><hr>
