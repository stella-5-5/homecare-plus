      ...
      <div class="container-fluid">
        <div class="row mb-2 w-100 ml-auto">
          <div class="col-sm-12">
            ...
            <hr>
            <h5 class="text-muted text-center">Let's Get started by visiting our patients</h5>
          </div><!-- /.col -->
        ...
        <?php foreach($pats as $i=>$pat):{?>
          <div class="col-lg-6">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                <p class="card-text">Hello I would like to schedule an appointment with you on <strong><?php echo htmlspecialchars($pat["appointment_date"])?></strong> Am currently in <strong><?php echo htmlspecialchars($pat["patient_location"])?></strong></p>
